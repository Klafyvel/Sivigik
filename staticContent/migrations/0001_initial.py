...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'staticContent_staticcontent', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('content', self.gf('django.db.models.fields.TextField')()),
            ('style', self.gf('django.db.models.fields.TextField')()),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['author.Author'])),
        ))
        db.send_create_signal(u'staticContent', ['StaticContent'])


    def backwards(self, orm):
        # Deleting model 'StaticContent'
        db.delete_table(u'staticContent_staticcontent')
